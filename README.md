...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pgsanity-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11878&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pgsanity-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pgsanity` can be installed with:

```
conda install pgsanity
```

It is possible to list all of the versions of `pgsanity` available on your platform with:
